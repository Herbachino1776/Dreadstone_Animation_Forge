...
For an offensive Action it also clears preview proof and the saved recipe proof
that must be regenerated by the existing approval workflow. The shared source
is never assigned for editing by this operation.
