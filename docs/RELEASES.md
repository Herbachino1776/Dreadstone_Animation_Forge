...
4. Complete the focused Blender acceptance in
   ...
   adaptive Blueprint reuse, validation, export, and clean reimport. For 6.0.2,
...
- [x] Version and `Dreadstone_Animation_Forge_v6_0_2.zip` match everywhere.
...
- [x] Blender acceptance proves the 6.0.2 sandbox consumes live sliders/meters,
