...
5. Use the top **IMPACT CONTROL DECK** to tune **SIZE**, **CRUSH**, **PROFILE**, **EDGE SAFETY**, and **CHAOS**; randomize the master impact seed; refresh preview; and commit without scrolling. Advanced raw controls remain available in explicit MANUAL mode. Organic raised gore can use the packaged random-direction muscle-fiber atlas and compromised inner-reddening layer.
