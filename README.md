...
Dreadstone Animation Forge `3.10.2` is a proprietary Blender add-on for animation drafting, protected damage-segment and stump authoring, trauma-field morph authoring, and GLB/manifest export. The supported runtime is Blender `5.1.2`.

## Install and open

1. Download `Dreadstone_Animation_Forge_v3_10_2.zip`.
